...
//     version 1.19.0
//     from Assets/Script/CarAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Script/CarAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CarAction: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""CarMap"",
            ""id"": ""94fe40a4-58e7-4dbf-ac59-60af9c8877ec"",
            ""actions"": [
                {
                    ""name"": ""Horizontal"",
                    ""type"": ""Value"",
                    ""id"": ""dee0a03f-c4e9-45b6-803d-a7c6c6e17ff2"",
                ...
                },
                {
                    ""name"": ""MouseLeft"",
                    ""type"": ""Button"",
                    ""id"": ""53041e7b-4504-4697-8321-1583ae39c1ca"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""ffae6103-a694-40aa-afd1-e04cd2cc084b"",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""7c8fbd35-85d3-420b-a8d0-b0ae5b20977a"",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""02759aab-8df9-478e-9e85-51e6c0ef5a7c"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""e52a4ed6-cc4b-4e5d-a572-90184007c338"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_CarMap_Horizontal = m_CarMap.FindAction("Horizontal", throwIfNotFound: true);
        m_CarMap_MouseLeft = m_CarMap.FindAction("MouseLeft", throwIfNotFound: true);
    }

    ~@CarAction()
    {
        UnityEngine.Debug.Assert(!m_CarMap.enabled, "This will cause a leak and performance issues, CarAction.CarMap.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_CarMap_Horizontal;
    private readonly InputAction m_CarMap_MouseLeft;
    /// <summary>
    ...
    public struct CarMapActions
    {
        ...
        /// </summary>
        public CarMapActions(@CarAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "CarMap/Horizontal".
        /// </summary>
        public InputAction @Horizontal => m_Wrapper.m_CarMap_Horizontal;
        /// <summary>
        /// Provides access to the underlying input action "CarMap/MouseLeft".
        /// </summary>
        public InputAction @MouseLeft => m_Wrapper.m_CarMap_MouseLeft;
        /// <summary>
